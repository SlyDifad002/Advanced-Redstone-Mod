 ...
 *
 *    Keep the SlyAdnancedRedstoneModElements object in this class and all calls to this object
...
public class SlyAdnancedRedstoneMod {
	public static final Logger LOGGER = LogManager.getLogger(SlyAdnancedRedstoneMod.class);
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(
			new ResourceLocation("sly_adnanced_redstone", "sly_adnanced_redstone"), () -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals,
