...
public class MCreatorFurn extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:furn")
	public static final Block block = null;
	@ObjectHolder("sly_adnanced_redstone:furn")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public MCreatorFurn(Elementssly_adnanced_redstone instance) {
		super(instance, 4);
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				MCreatorFurnOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
