...
import net.mcreator.sly_adnanced_redstone.procedures.TococOnBlockRightClickedProcedure;
...
public class TococBlock extends SlyAdnancedRedstoneModElements.ModElement {
	@ObjectHolder("sly_adnanced_redstone:tococ")
	public static final Block block = null;
	public TococBlock(SlyAdnancedRedstoneModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				TococOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
