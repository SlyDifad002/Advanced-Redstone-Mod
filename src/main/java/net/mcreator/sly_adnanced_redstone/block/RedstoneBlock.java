...
public class RedstoneBlock extends SlyAdnancedRedstoneModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("redstone_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sly_adnanced_redstone:redstone_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
