...
import net.mcreator.sly_adnanced_redstone.procedures.FurnBlockDestroyedByPlayerProcedure;
import net.mcreator.sly_adnanced_redstone.procedures.FurnBlockDestroyedByExplosionProcedure;
...
public class FurnBlock extends SlyAdnancedRedstoneModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				FurnBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				FurnBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
