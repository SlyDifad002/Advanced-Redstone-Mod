...
public class RedplantBlock extends SlyAdnancedRedstoneModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("redplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sly_adnanced_redstone:redplant"), configuredFeature);
		}
	}
	@SubscribeEvent
