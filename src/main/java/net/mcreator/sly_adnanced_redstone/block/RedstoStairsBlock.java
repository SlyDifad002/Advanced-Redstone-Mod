...
public class RedstoStairsBlock extends SlyAdnancedRedstoneModElements.ModElement {
	@ObjectHolder("sly_adnanced_redstone:redsto_stairs")
	public static final Block block = null;
	public RedstoStairsBlock(SlyAdnancedRedstoneModElements instance) {
		super(instance, 129);
	}
