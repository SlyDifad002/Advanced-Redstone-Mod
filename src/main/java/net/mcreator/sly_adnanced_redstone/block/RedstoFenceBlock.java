...
public class RedstoFenceBlock extends SlyAdnancedRedstoneModElements.ModElement {
	@ObjectHolder("sly_adnanced_redstone:redsto_fence")
	public static final Block block = null;
	public RedstoFenceBlock(SlyAdnancedRedstoneModElements instance) {
		super(instance, 131);
	}
