...
public class LogBlock extends SlyAdnancedRedstoneModElements.ModElement {
	@ObjectHolder("sly_adnanced_redstone:log")
	public static final Block block = null;
	public LogBlock(SlyAdnancedRedstoneModElements instance) {
		super(instance, 181);
	}
