...
import net.mcreator.sly_adnanced_redstone.procedures.AdvancedredstoneBlockIsPlacedByProcedure;
...
public class AdvancedredstoneBlock extends SlyAdnancedRedstoneModElements.ModElement {
	@ObjectHolder("sly_adnanced_redstone:advancedredstone")
	public static final Block block = null;
	public AdvancedredstoneBlock(SlyAdnancedRedstoneModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("advancedredstone");
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				AdvancedredstoneBlockIsPlacedByProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
