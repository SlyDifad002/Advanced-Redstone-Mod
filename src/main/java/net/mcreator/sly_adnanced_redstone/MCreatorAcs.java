...
public class MCreatorAcs extends Elementssly_adnanced_redstone.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorAcs(Elementssly_adnanced_redstone instance) {
		super(instance, 29);
	...
	public static class GuiContainerMod extends Container {
		...
		public void initContainer(PlayerInventory inv, IInventory inheritedinv) {
			...
			this.addSlot(new Slot(inherited, 1, 141, 36) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			});
			this.addSlot(new Slot(inherited, 0, 17, 38) {
				@Override
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Instant redstone furnace", 27, 12, -10092544);
		}
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				MCreatorInput.executeProcedure($_dependencies);
			}
		}
	}
}
