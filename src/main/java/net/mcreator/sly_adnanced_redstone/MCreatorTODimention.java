...
public class MCreatorTODimention extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:todimention")
	public static final Block block = null;

	public MCreatorTODimention(Elementssly_adnanced_redstone instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			Block block = this;
			{
				...
				MCreatorTODimentionBlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			Block block = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorTODimentionBlockIsPlacedBy.executeProcedure($_dependencies);
			}
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorTODimentionOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
