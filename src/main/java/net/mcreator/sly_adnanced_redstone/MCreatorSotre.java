...
public class MCreatorSotre extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:sotre")
	public static final Block block = null;
	@ObjectHolder("sly_adnanced_redstone:sotre")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public MCreatorSotre(Elementssly_adnanced_redstone instance) {
		super(instance, 56);
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				MCreatorSotreOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
