...
import net.mcreator.sly_adnanced_redstone.entity.renderer.RedstonedRenderer;
...
public class RedstonedEntity extends SlyAdnancedRedstoneModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.7f)).build("redstoned").setRegistryName("redstoned");
	public RedstonedEntity(SlyAdnancedRedstoneModElements instance) {
		super(instance, 111);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RedstonedRenderer.ModelRegisterHandler());
