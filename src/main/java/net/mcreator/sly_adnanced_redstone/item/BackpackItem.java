...
public class BackpackItem extends SlyAdnancedRedstoneModElements.ModElement {
	@ObjectHolder("sly_adnanced_redstone:backpack")
	public static final Item block = null;
	public BackpackItem(SlyAdnancedRedstoneModElements instance) {
		super(instance, 168);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(RWEItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Holds Items"));
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new StorageGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			}
			{
				...
				BackpackRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
