...
public class MCreatorTeleblock2 extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:teleblock2")
	public static final Block block = null;

	public MCreatorTeleblock2(Elementssly_adnanced_redstone instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			Block block = this;
			{
				...
				MCreatorTeleblock2BlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			Block block = this;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("world", world);
				MCreatorTeleblock2BlockDestroyedByExplosion.executeProcedure($_dependencies);
			}
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			Block block = this;
			{
				...
				$_dependencies.put("world", world);
				MCreatorTeleblock2BlockIsPlacedBy.executeProcedure($_dependencies);
			}
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("world", world);
				MCreatorTeleblock2OnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
