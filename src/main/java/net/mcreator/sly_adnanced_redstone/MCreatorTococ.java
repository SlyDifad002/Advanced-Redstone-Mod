...
public class MCreatorTococ extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:tococ")
	public static final Block block = null;

	public MCreatorTococ(Elementssly_adnanced_redstone instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				MCreatorTococOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
