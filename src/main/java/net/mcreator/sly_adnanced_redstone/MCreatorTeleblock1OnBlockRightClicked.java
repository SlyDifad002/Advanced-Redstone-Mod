...
public class MCreatorTeleblock1OnBlockRightClicked extends Elementssly_adnanced_redstone.ModElement {
	public MCreatorTeleblock1OnBlockRightClicked(Elementssly_adnanced_redstone instance) {
		super(instance, 69);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure MCreatorTeleblock1OnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MCreatorTeleblock1OnBlockRightClicked!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		World world = (World) dependencies.get("world");
		if ((!(((sly_adnanced_redstoneVariables.MapVariables.get(world).Location121) == 0) && (((sly_adnanced_redstoneVariables.MapVariables
				.get(world).Location122) == 0) && ((sly_adnanced_redstoneVariables.MapVariables.get(world).Location123) == 0))))) {
			if (((sly_adnanced_redstoneVariables.MapVariables.get(world).Dim11) == 1)) {
			...
			} else if (((sly_adnanced_redstoneVariables.MapVariables.get(world).Dim11) == 2)) {
			...
			} else if (((sly_adnanced_redstoneVariables.MapVariables.get(world).Dim11) == 3)) {
				if (((1) == (world.getDimension().getType().getId()))) {
					if (entity instanceof LivingEntity)
						((LivingEntity) entity).setPositionAndUpdate((sly_adnanced_redstoneVariables.MapVariables.get(world).Location121),
								(sly_adnanced_redstoneVariables.MapVariables.get(world).Location122),
			...
			} else if (((sly_adnanced_redstoneVariables.MapVariables.get(world).Dim11) == 4)) {
