...
public class MCreatorAdvancedredstone extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:advancedredstone")
	public static final Block block = null;

	public MCreatorAdvancedredstone(Elementssly_adnanced_redstone instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			Block block = this;
			{
				...
				MCreatorAdvancedredstoneBlockIsPlacedBy.executeProcedure($_dependencies);
			}
		}
	}
}
