...
public class Duplicator1Procedure extends SlyAdnancedRedstoneModElements.ModElement {
	public Duplicator1Procedure(SlyAdnancedRedstoneModElements instance) {
		super(instance, 149);
	}
