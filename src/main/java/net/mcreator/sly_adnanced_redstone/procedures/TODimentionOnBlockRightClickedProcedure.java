...
public class TODimentionOnBlockRightClickedProcedure extends SlyAdnancedRedstoneModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!world.getWorld().isRemote) {
			...
			if (template != null) {
				template.addBlocksToWorld(world, new BlockPos((int) x, (int) y, (int) z), new PlacementSettings().setRotation(Rotation.CLOCKWISE_180)
						.setMirror(Mirror.FRONT_BACK).setChunk(null).setIgnoreEntities(false));
			}
		}
	}
}
