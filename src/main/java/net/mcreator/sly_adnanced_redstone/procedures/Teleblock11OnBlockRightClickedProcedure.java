	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Teleblock11OnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure Teleblock11OnBlockRightClicked!");
			return;
		}
			...
			if (((SlyAdnancedRedstoneModVariables.MapVariables.get(world).Dim1) == 1)) {
				if (((0) == (world.getDimension().getType().getId()))) {
					...
					if (!world.getWorld().isRemote) {
						...
						world.getWorld().playSound((SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location111),
								(SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location112),
								(SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location113),
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
										.getValue(new ResourceLocation("entity.enderman.teleport")),
