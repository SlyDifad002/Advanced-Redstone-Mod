	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SlyAdnancedRedstoneMod.LOGGER.warn("Failed to load dependency entity for procedure Teleblock2OnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SlyAdnancedRedstoneMod.LOGGER.warn("Failed to load dependency world for procedure Teleblock2OnBlockRightClicked!");
			return;
		}
		...
		if ((!(((SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location221) == 0)
			...
			if (world instanceof World && !world.isRemote()) {
				...
				((World) world).playSound((SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location221),
						(SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location222),
						(SlyAdnancedRedstoneModVariables.MapVariables.get(world).Location223),
						(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.enderman.teleport")),
