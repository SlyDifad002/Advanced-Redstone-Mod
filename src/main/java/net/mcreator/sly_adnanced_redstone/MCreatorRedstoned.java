...
public class MCreatorRedstoned extends Elementssly_adnanced_redstone.ModElement {
	public static EntityType entity = null;

	public MCreatorRedstoned(Elementssly_adnanced_redstone instance) {
		super(instance, 111);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity> create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.7f)).build("redstoned")
				.setRegistryName("redstoned");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3407872, -10092544, new Item.Properties().group(MCreatorRWE.tab))
				.setRegistryName("redstoned"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(8, new TemptGoal(this, 5, Ingredient.fromItems(new ItemStack(MCreatorAdc.block, (int) (1)).getItem()), false));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				MCreatorRedstonedEntityDies.executeProcedure($_dependencies);
			}
		}
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorRedstonedOnInitialEntitySpawn.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			int z = (int) this.posZ;
			{
				...
				MCreatorRedstonedPlayerCollidesWithThisEntity.executeProcedure($_dependencies);
			}
		}
