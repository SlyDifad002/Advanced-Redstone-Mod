...
public class MCreatorTeleblock1 extends Elementssly_adnanced_redstone.ModElement {
	@ObjectHolder("sly_adnanced_redstone:teleblock1")
	public static final Block block = null;

	public MCreatorTeleblock1(Elementssly_adnanced_redstone instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			Block block = this;
			{
				...
				MCreatorTeleblock1BlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			Block block = this;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("world", world);
				MCreatorTeleblock1BlockDestroyedByExplosion.executeProcedure($_dependencies);
			}
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			Block block = this;
			{
				...
				$_dependencies.put("world", world);
				MCreatorTeleblock1BlockIsPlacedBy.executeProcedure($_dependencies);
			}
		}
