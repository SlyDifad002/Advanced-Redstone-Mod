...
public class Storage2Gui extends SlyAdnancedRedstoneModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public Storage2Gui(SlyAdnancedRedstoneModElements instance) {
		super(instance, 166);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("storage_2"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("sly_adnanced_redstone:textures/storage_2.png");
		@Override
