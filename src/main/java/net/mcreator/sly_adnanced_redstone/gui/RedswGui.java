...
import net.mcreator.sly_adnanced_redstone.procedures.OnpresdeProcedure;
...
public class RedswGui extends SlyAdnancedRedstoneModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public RedswGui(SlyAdnancedRedstoneModElements instance) {
		super(instance, 55);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 17, 34) {
			}));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 49, this.guiTop + 57, 70, 20, "Convert", e -> {
		...
		if (buttonID == 0) {
			{
				...
				OnpresdeProcedure.executeProcedure($_dependencies);
			}
		}
	}
