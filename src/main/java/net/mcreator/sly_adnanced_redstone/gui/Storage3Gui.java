...
public class Storage3Gui extends SlyAdnancedRedstoneModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public Storage3Gui(SlyAdnancedRedstoneModElements instance) {
		super(instance, 167);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("storage_3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("sly_adnanced_redstone:textures/storage_3.png");
		@Override
